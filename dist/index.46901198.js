"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global&&global;class e{#e="";#t="";#n="";render(){}renderSpinner(){}renderMessage(){}renderErrorMessage(){}renderMarkup(){}renderClear(){this.#e.innerHTML=""}}var t=new class extends e{#e=document.querySelector(".btn-login");render(){console.log("you clicked login button")}addHandlerLogin(e){this.#e.addEventListener("click",e)}};var n=new class extends e{#e=document.querySelector(".btn-logout");render(){console.log("you clicked logout button"),this.#e.classList.remove("hidden")}addHandlerLogin(e){this.#e.addEventListener("click",e)}};var i=new class{#e=document.querySelector(".btn-signup");render(){console.log("you clicked signup button")}addHandlerLogin(e){this.#e.addEventListener("click",e)}};new class extends e{#e=document.querySelector(".btn-login");addHandlerLogin(e){this.#e.addEventListener("click",e)}};
/*! *****************************************************************************
